    ...
    <body>
        ...
        <div class="container">
            <div class="row  mt-4 justify-content-center">             
                <div class="text-center col-md-4 col-md-offset-6 justify-content-md-center">                  
                    <div class="login-panel panel">      

                        <div class="card">
                            <div class="card-body">
                                <div class="panel-default">                    
                                    <img src="/proyectofinaljavaweb/assets/img/logo.svg" alt="" width="223" height="105">
                                </div>
